<flux:main>
    <div class="flex justify-between gap-10 mb-12">
        <flux:heading size="xl" level="1">{{__('commons.pageName.admin.admin.messages')}}</flux:heading>
    ...
    <div
        ...
        <flux:table :paginate="$this->suggestMessages">
            <flux:table.columns>
    ...
    <div
        ...
        <flux:table :paginate="$this->newMerchantMessages">
            <flux:table.columns>
