...
### 2. Les commerçants
Les commerçants qui se sépare aussi en deux types, le nouveau et le commerçant déjà inscrit sur la plateforme.
...
L'administrateur est le gestionnaire de la plateforme. Il agit comme intermédiaire entre les clients et les commerçants : il centralise le stockage des produits dans l'entrepôt, gère les créneaux de retrait et assure la transaction sur place. Il contrôle également l'accès à la plateforme en faisant passer un entretien aux commerçants souhaitant rejoindre Picklio.

Liste des tâches que l'administrateur pourrait accomplir :

- **Gérer le stock** : il consulte l'état du stock global, ajuste les quantités et suit les mouvements des produits. Il peut identifier les ruptures et contacter les commerçants concernés.
- **Gérer les commandes** : il suit les commandes en cours et terminées, met à jour leurs statuts (en attente, prête, retirée) et peut imprimer un ticket ou une facture.
- **Gérer les commerçants** : il ajoute, modifie ou désactive un compte commerçant. Il reçoit les demandes de formulaire de contact et recontacte les candidats pour organiser un entretien.
- **Gérer les créneaux de retrait** : il crée les horaires de retrait disponibles, limite le nombre de commandes par créneau et peut fermer exceptionnellement un créneau.
- **Lire les messages** : il accède à sa messagerie pour communiquer avec les commerçants ou répondre aux demandes du formulaire de contact du site vitrine.
- **Suivre les statistiques globales** : il consulte les revenus globaux, les produits les plus vendus et l'activité des commerçants partenaires.
